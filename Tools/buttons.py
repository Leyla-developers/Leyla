...
class Warns(disnake.ui.View):
    ...
    async def warns(self, button, inter):
        ...
        await inter.response.send_message(
            f"Ваша ссылка: [нажмите, чтобы просмотреть все предупреждения](https://www.toptal.com/developers/hastebin/{pastebin_data['key']})", ephemeral=True)
...
class CurrencyButton(disnake.ui.View):
    ...
    async def currency_button(self, button, inter):
        currencies = [
            ...
            'HUF - Венгерских форинтов', 'HKD - Гонконгский доллар', 'DKK - Датская крона',
            'USD - Доллар США', 'EUR - Евро', 'INR - Индийских рупий', 'KZT - Казахстанских тенге',
            'CAD - Канадский доллар', 'KGS - Киргизских сомов', 'CNY - Китайский юань',
            'MDL - Молдавских леев', 'NOK - Норвежская крона', 'PLN - Польский злотый',
            'RON - Румынский лей', 'XDR - СДР (специальные права заимствования)',
            'SGD - Сингапурский доллар', 'TJS - Таджикских сомони', 'TRY - Турецких лир',
            'TMT - Новый туркменский манат', 'UZS - Узбекских сумов', 'UAH - Украинских гривен',
            'CZK - Чешских крон', 'SEK - Шведская крона', 'CHF - Швейцарский франк',
            'ZAR - Южноафриканских рэндов', 'KRW - Вон Республики Корея', 'JPY - Японских иен'
        ]
        await inter.response.send_message('\n'.join(currencies), ephemeral=True)
