...
DESCRIPTIONS = {
    ...
    NotLoggedIn: "Авторизауия не прошла успешно, если вы владелец этого аккаунта, то можете зайти на [hoyolab](https://www.hoyolab.com/home), далее зайти в свой профиль. Далее нажимаете F12, application, cookies, и ищите в таблице строки `ltuid` и `ltoken`, и копируете оттуда данные, далее вставляете в команду вновь.",
    DataNotPublic: "Информация об аккаунте не публичная, если вы владелец аккаунта, то можете зайти на [hoyolab](https://www.hoyolab.com/home), далее настройки, и в категории боевых заслуг переключаете первую кнопку"
}
