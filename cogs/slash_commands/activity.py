...
class Activities(commands.Cog):
    ...
    async def discord_activity(self, inter, voice_channel: disnake.VoiceChannel, activity_name: Literal['youtube', 'poker', 'betrayal', 
                                                                                                        'fishing', 'chess', 'letter-tile',
                                                                                                        'word-snack', 'doodle-crew']):
